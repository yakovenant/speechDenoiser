...
class ModelParams(DfParams):
    def __init__(self):
        ...
        self.__params = getattr(import_module("src.denoiser.DeepFilterNet.DeepFilterNet.df." + self.__model, package=None), "ModelParams")()
...
def init_model(*args, **kwargs):
    ...
    model = getattr(import_module("src.denoiser.DeepFilterNet.DeepFilterNet.df." + model), "init_model")(*args, **kwargs)
